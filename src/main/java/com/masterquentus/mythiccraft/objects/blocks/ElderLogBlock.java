...
public class ElderLogBlock extends LogBlock{
	...
	public ElderLogBlock(MaterialColor verticalColorIn, Properties properties) {
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (held instanceof AxeItem){
            BlockState newState = BlockInit.elder_stripped_log.get().getDefaultState().with(RotatedPillarBlock.AXIS, state.get(RotatedPillarBlock.AXIS));
