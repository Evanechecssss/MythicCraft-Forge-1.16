...
public class SeaCandlesBlock extends BushBlock implements IGrowable, IWaterLoggable {

	public static final IntegerProperty CANDLES = BlockStateProperties.PICKLES;
	   ...
	   public SeaCandlesBlock(AbstractBlock.Properties p_i48924_1_) {
	      super(p_i48924_1_);
	      this.registerDefaultState(this.stateDefinition.any().setValue(CANDLES, Integer.valueOf(1)).setValue(WATERLOGGED, Boolean.valueOf(true)));
	   }
	...
	public boolean canBeReplaced(BlockState p_196253_1_, BlockItemUseContext p_196253_2_) {
	   ...
	   public VoxelShape getShape(BlockState p_220053_1_, IBlockReader p_220053_2_, BlockPos p_220053_3_, ISelectionContext p_220053_4_) {
	      switch(p_220053_1_.getValue(CANDLES)) {
	      case 1:
	      default:
	         return ONE_AABB;
	      case 2:
	...
	public FluidState getFluidState(BlockState p_204507_1_) {
	   ...
	   protected void createBlockStateDefinition(StateContainer.Builder<Block, BlockState> p_206840_1_) {
	      p_206840_1_.add(CANDLES, WATERLOGGED);
	   }
	...
	public void performBonemeal(ServerWorld p_225535_1_, Random p_225535_2_, BlockPos p_225535_3_, BlockState p_225535_4_) {
	      if (!isDead(p_225535_4_) && p_225535_1_.getBlockState(p_225535_3_.below()).is(BlockTags.CORAL_BLOCKS)) {
	               ...
	               for(int j2 = i2 - 2; j2 < i2; ++j2) {
	                  ...
	                  if (blockpos != p_225535_3_ && p_225535_2_.nextInt(6) == 0 && p_225535_1_.getBlockState(blockpos).is(Blocks.WATER)) {
	                     ...
	                     if (blockstate.is(BlockTags.CORAL_BLOCKS)) {
	                        p_225535_1_.setBlock(blockpos, Blocks.SEA_PICKLE.defaultBlockState().setValue(CANDLES, Integer.valueOf(p_225535_2_.nextInt(4) + 1)), 3);
	                     }
	                  }
	               }
	            }
	         ...
	         p_225535_1_.setBlock(p_225535_3_, p_225535_4_.setValue(CANDLES, Integer.valueOf(4)), 2);
	      }
