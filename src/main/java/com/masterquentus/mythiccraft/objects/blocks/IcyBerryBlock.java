...
public class IcyBerryBlock extends SweetBerryBushBlock implements IGrowable {
	...
	public IcyBerryBlock(Properties properties) {
		super(properties);
	...
	public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
		...
		if (i < 3 && p_225534_2_.getRawBrightness(p_225534_3_.above(), 0) >= 9 && net.minecraftforge.common.ForgeHooks
				.onCropsGrowPre(p_225534_2_, p_225534_3_, p_225534_1_, p_225534_4_.nextInt(5) == 0)) {
	...
	public ActionResultType use(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_,
		...
		if (!flag && p_225533_4_.getItemInHand(p_225533_5_).getItem() == Items.BONE_MEAL) {
			...
			p_225533_2_.playSound((PlayerEntity) null, p_225533_3_, SoundEvents.SWEET_BERRY_BUSH_PICK_BERRIES,
					SoundCategory.BLOCKS, 1.0F, 0.8F + p_225533_2_.random.nextFloat() * 0.4F);
	...
	public ItemStack getCloneItemStack(IBlockReader p_1854731, BlockPos p_1854732, BlockState p_1854733) {
		return new ItemStack(ItemInit.icy_berry.get());
