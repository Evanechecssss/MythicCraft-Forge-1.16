...
public class DimensionInit {
	...
	public static final RegistryKey<World> MIRROR_DIMENSION_WORLD = RegistryKey.create(Registry.DIMENSION_REGISTRY,
			new ResourceLocation(MythicCraft.MOD_ID, "mirror_dimension"));
