...
public enum StoneType {
    ...
    public void register(DeferredRegister<Block> blockRegistry) {
        ...
        for (StoneType.StoneVariation variation : StoneType.StoneVariation.values()){
            ...
            if (variation == StoneType.StoneVariation.STONE && (name.equals("crimson") || name.equals("charred") || name.equals("infested"))){
                typeString = "stone";
            }
            ...
            this.blocks.put(variation, blockRegistry.register(name + (typeString.equals("") ? "" : "_" + typeString), () -> new Block(props)));
            this.stairs.put(variation, blockRegistry.register(name + typeString + "_stairs", () -> new StairsBlock(() -> this.stairs.get(variation).get().defaultBlockState(), props)));
            this.slabs.put(variation, blockRegistry.register(name + typeString + "_slab", () -> new SlabBlock(props)));
            this.buttons.put(variation, blockRegistry.register(name + typeString + "_button", () -> new ModStoneButtonBlock(props)));
