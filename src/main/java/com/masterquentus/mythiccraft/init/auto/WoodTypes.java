...
public enum WoodTypes {
    ...
    public void register(DeferredRegister<Block> blockRegistry) {
        ...
        this.strippedLog = blockRegistry.register(name + "_stripped_log", () -> new ModLogBlock(MaterialColor.COLOR_RED, true));
        ...
        this.slab = blockRegistry.register(name + "_slab", () -> new SlabBlock(Block.Properties.copy(this.plank.get())));
        this.button = blockRegistry.register(name + "_button", () -> new ModWoodButtonBlock(Block.Properties.of(Material.WOOD, MaterialColor.COLOR_RED)));
        this.pressureplate = blockRegistry.register(name + "_pressureplate", () -> new ModWoodPressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, Block.Properties.of(Material.WOOD, MaterialColor.COLOR_RED)));
        this.fence = blockRegistry.register(name + "_fence", () -> new FenceBlock(Block.Properties.of(Material.WOOD, MaterialColor.COLOR_RED)));
        this.gate = blockRegistry.register(name + "_fence_gate", () -> new FenceGateBlock(Block.Properties.copy(Blocks.OAK_FENCE_GATE)));
        this.sapling = blockRegistry.register(name + "_sapling", () -> new SaplingBlock(this.tree, Block.Properties.copy(Blocks.OAK_SAPLING)));
    }
}
