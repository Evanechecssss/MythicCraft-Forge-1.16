...
public class BlockInit {
	...
	public static final RegistryObject<Block> CHARRED_SOIL = BLOCKS.register("charred_soil",
			() -> new ModGrassBlock(Block.Properties.of(Material.SAND, MaterialColor.BLACK).sound(SoundType.SAND)
	...
	public static final RegistryObject<Block> INFESTED_SOIL = BLOCKS.register("infested_soil",
			() -> new ModGrassBlock(Block.Properties.of(Material.SAND, MaterialColor.MAGENTA)
	...
	public static final RegistryObject<Block> BLOODLY_SOIL = BLOCKS.register("bloodly_soil",
			() -> new ModGrassBlock(Block.Properties.of(Material.SAND, MaterialColor.RED).sound(SoundType.GROUND)
					.harvestTool(ToolType.SHOVEL).harvestLevel(0)));
	public static final RegistryObject<Block> DEEP_SOIL = BLOCKS.register("deep_soil",
			() -> new ModGrassBlock(Block.Properties.of(Material.GOURD, MaterialColor.BLACK).sound(SoundType.GROUND)
					.harvestTool(ToolType.SHOVEL).harvestLevel(0)));
	...
	public static final RegistryObject<Block> ROSEQUARTZ_PILLAR = BLOCKS.register("rosequartz_pillar",
			() -> new LogBlock(MaterialColor.WHITE_TERRACOTTA,
					Block.Properties.copy(Blocks.QUARTZ_PILLAR).strength(5.0f, 30.0f)
							.sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).harvestLevel(1)));
	...
	public static final RegistryObject<Block> BLACK_PACKEDICE = BLOCKS.register("black_packedice",
			() -> new Block(Block.Properties.copy(Blocks.PACKED_ICE).strength(0.3f, 0.2f)
					.sound(SoundType.GLASS).slipperiness(0.98f).speedFactor(0.7f).randomTicks().notSolid()));
	public static final RegistryObject<Block> PIXIE_GLASS = BLOCKS.register("pixie_glass", () -> new Block(
			Block.Properties.copy(Blocks.GLASS).strength(0.3f, 0.2f).sound(SoundType.GLASS).notSolid()));
	...
	public static final RegistryObject<Block> BLOOD_TORCH = BLOCKS.register("blood_torch",
			() -> new ModTorchBlock(Block.Properties.copy(Blocks.TORCH).strength(0.3f, 0.2f)
	...
	public static final RegistryObject<Block> BLOODY_ROSE = BLOCKS.register("bloody_rose",
			() -> new FlowerBlock(Effects.NIGHT_VISION, 5,
					Block.Properties.copy(Blocks.POPPY).strength(0.3f, 0.2f).sound(SoundType.PLANT)));

	// Mushrooms

	// Saplings
	public static final RegistryObject<Block> bloodoak_sapling = BLOCKS.register("bloodoak_sapling",
			() -> new ModSaplingBlock(() -> new BloodOakTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> whiteoak_sapling = BLOCKS.register("whiteoak_sapling",
			() -> new ModSaplingBlock(() -> new WhiteOakTree(), Block.Properties.copy(Blocks.DARK_OAK_SAPLING)));
	public static final RegistryObject<Block> silverwood_sapling = BLOCKS.register("silverwood_sapling",
			() -> new ModSaplingBlock(() -> new SilverWoodTree(), Block.Properties.copy(Blocks.BIRCH_SAPLING)));
	public static final RegistryObject<Block> witchwood_sapling = BLOCKS.register("witchwood_sapling",
			() -> new ModSaplingBlock(() -> new WitchWoodTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> alder_sapling = BLOCKS.register("alder_sapling",
			() -> new ModSaplingBlock(() -> new AlderTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> hawthorn_sapling = BLOCKS.register("hawthorn_sapling",
			() -> new ModSaplingBlock(() -> new HawthornTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> rowan_sapling = BLOCKS.register("rowan_sapling",
			() -> new ModSaplingBlock(() -> new RowanTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> willow_sapling = BLOCKS.register("willow_sapling",
			() -> new ModSaplingBlock(() -> new WillowTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> beech_sapling = BLOCKS.register("beech_sapling",
			() -> new ModSaplingBlock(() -> new BeechTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> ash_sapling = BLOCKS.register("ash_sapling",
			() -> new ModSaplingBlock(() -> new AshTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> blackthorn_sapling = BLOCKS.register("blackthorn_sapling",
			() -> new ModSaplingBlock(() -> new BlackthornTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> cedar_sapling = BLOCKS.register("cedar_sapling",
			() -> new ModSaplingBlock(() -> new CedarTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> elder_sapling = BLOCKS.register("elder_sapling",
			() -> new ModSaplingBlock(() -> new ElderTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> juniper_sapling = BLOCKS.register("juniper_sapling",
			() -> new ModSaplingBlock(() -> new JuniperTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> witchhazel_sapling = BLOCKS.register("witchhazel_sapling",
			() -> new ModSaplingBlock(() -> new WitchHazelTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> yew_sapling = BLOCKS.register("yew_sapling",
			() -> new ModSaplingBlock(() -> new YewTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> infested_sapling = BLOCKS.register("infested_sapling",
			() -> new ModSaplingBlock(() -> new InfestedTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> charred_sapling = BLOCKS.register("charred_sapling",
			() -> new ModSaplingBlock(() -> new CharredTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> ICY_SAPLING = BLOCKS.register("icy_sapling",
			() -> new ModSaplingBlock(() -> new IcyTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> DISTORTED_SAPLING = BLOCKS.register("distorted_sapling",
			() -> new ModSaplingBlock(() -> new DistortedTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));
	public static final RegistryObject<Block> TWISTED_SAPLING = BLOCKS.register("twisted_sapling",
			() -> new ModSaplingBlock(() -> new TwistedTree(), Block.Properties.copy(Blocks.ACACIA_SAPLING)));

	// Logs
	public static RegistryObject<Block> createStripableLog(String registryName){
		return BLOCKS.register(registryName, () -> new ModLogBlock(MaterialColor.COLOR_RED));
	}

	public static final RegistryObject<Block> bloodoak_log = createStripableLog("bloodoak_log");
	public static final RegistryObject<Block> silverwood_log = createStripableLog("silverwood_log");
	public static final RegistryObject<Block> witchwood_log = createStripableLog("witchwood_log");
	public static final RegistryObject<Block> whiteoak_log = createStripableLog("whiteoak_log");
	public static final RegistryObject<Block> alder_log = createStripableLog("alder_log");
	public static final RegistryObject<Block> hawthorn_log = createStripableLog("hawthorn_log");
	public static final RegistryObject<Block> rowan_log = createStripableLog("rowan_log");
	public static final RegistryObject<Block> willow_log = createStripableLog("willow_log");
	public static final RegistryObject<Block> beech_log = createStripableLog("beech_log");
	public static final RegistryObject<Block> ash_log = createStripableLog("ash_log");
	public static final RegistryObject<Block> blackthorn_log = createStripableLog("blackthorn_log");
	public static final RegistryObject<Block> cedar_log = createStripableLog("cedar_log");
	public static final RegistryObject<Block> elder_log = createStripableLog("elder_log");
	public static final RegistryObject<Block> juniper_log = createStripableLog("juniper_log");
	public static final RegistryObject<Block> witchhazel_log = createStripableLog("witchhazel_log");
	public static final RegistryObject<Block> yew_log = createStripableLog("yew_log");
	public static final RegistryObject<Block> infested_log = createStripableLog("infested_log");
	public static final RegistryObject<Block> charred_log = createStripableLog("charred_log");
	public static final RegistryObject<Block> ICY_LOG = createStripableLog("icy_log");
	public static final RegistryObject<Block> DISTORTED_LOG = createStripableLog("distorted_log");
	public static final RegistryObject<Block> TWISTED_LOG = createStripableLog("twisted_log");

	public static RegistryObject<Block> createAlreadyStrippedLog(String registryName){
		return BLOCKS.register(registryName, () -> new ModLogBlock(MaterialColor.COLOR_RED, true));
	}

	public static final RegistryObject<Block> bloodoak_stripped_log = createAlreadyStrippedLog("bloodoak_stripped_log");
	public static final RegistryObject<Block> whiteoak_stripped_log = createAlreadyStrippedLog("whiteoak_stripped_log");
	public static final RegistryObject<Block> silverwood_stripped_log = createAlreadyStrippedLog("silverwood_stripped_log");
	public static final RegistryObject<Block> witchwood_stripped_log = createAlreadyStrippedLog("witchwood_stripped_log");
	public static final RegistryObject<Block> alder_stripped_log = createAlreadyStrippedLog("alder_stripped_log");
	public static final RegistryObject<Block> hawthorn_stripped_log = createAlreadyStrippedLog("hawthorn_stripped_log");
	public static final RegistryObject<Block> rowan_stripped_log = createAlreadyStrippedLog("rowan_stripped_log");
	public static final RegistryObject<Block> willow_stripped_log = createAlreadyStrippedLog("willow_stripped_log");
	public static final RegistryObject<Block> beech_stripped_log = createAlreadyStrippedLog("beech_stripped_log");
	public static final RegistryObject<Block> ash_stripped_log = createAlreadyStrippedLog("ash_stripped_log");
	public static final RegistryObject<Block> blackthorn_stripped_log = createAlreadyStrippedLog("blackthorn_stripped_log");
	public static final RegistryObject<Block> cedar_stripped_log = createAlreadyStrippedLog("cedar_stripped_log");
	public static final RegistryObject<Block> elder_stripped_log = createAlreadyStrippedLog("elder_stripped_log");
	public static final RegistryObject<Block> juniper_stripped_log = createAlreadyStrippedLog("juniper_stripped_log");
	public static final RegistryObject<Block> witchhazel_stripped_log = createAlreadyStrippedLog("witchhazel_stripped_log");
	public static final RegistryObject<Block> yew_stripped_log = createAlreadyStrippedLog("yew_stripped_log");
	public static final RegistryObject<Block> infested_stripped_log = createAlreadyStrippedLog("infested_stripped_log");
	public static final RegistryObject<Block> charred_stripped_log = createAlreadyStrippedLog("charred_stripped_log");
	public static final RegistryObject<Block> icy_stripped_log = createAlreadyStrippedLog("icy_stripped_log");
	public static final RegistryObject<Block> distorted_stripped_log = createAlreadyStrippedLog("distorted_stripped_log");
	public static final RegistryObject<Block> ICY_STRIPPED_LOG = createAlreadyStrippedLog("icy_stripped_log");
	public static final RegistryObject<Block> TWISTED_STRIPPED_LOG = createAlreadyStrippedLog("twisted_stripped_log");

	public static final RegistryObject<Block> BLOODOAK_WOOD = BLOCKS.register("bloodoak_wood",
			() -> new BloodOakWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> WHITEOAK_WOOD = BLOCKS.register("whiteoak_wood",
			() -> new WhiteOakWoodBlock(MaterialColor.WHITE_TERRACOTTA, Block.Properties.copy(Blocks.DARK_OAK_LOG)));
	public static final RegistryObject<Block> SILVERWOOD_WOOD = BLOCKS.register("silverwood_wood",
			() -> new SilverWoodBlock(MaterialColor.WHITE_TERRACOTTA, Block.Properties.copy(Blocks.BIRCH_LOG)));
	public static final RegistryObject<Block> WITCHWOOD_WOOD = BLOCKS.register("witchwood_wood",
			() -> new WitchWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> ALDER_WOOD = BLOCKS.register("alder_wood",
			() -> new AlderWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> HAWTHORN_WOOD = BLOCKS.register("hawthorn_wood",
			() -> new HawthornWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> ROWAN_WOOD = BLOCKS.register("rowan_wood",
			() -> new RowanWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> WILLOW_WOOD = BLOCKS.register("willow_wood",
			() -> new WillowWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> BEECH_WOOD = BLOCKS.register("beech_wood",
			() -> new BeechWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> ASH_WOOD = BLOCKS.register("ash_wood",
			() -> new AshWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> BLACKTHORN_WOOD = BLOCKS.register("blackthorn_wood",
			() -> new BlackthornWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> CEDAR_WOOD = BLOCKS.register("cedar_wood",
			() -> new CedarWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> ELDER_WOOD = BLOCKS.register("elder_wood",
			() -> new ElderWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> JUNIPERWOOD = BLOCKS.register("juniper_wood",
			() -> new JuniperWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> WITCHHAZEL_WOOD = BLOCKS.register("witchhazel_wood",
			() -> new WitchHazelWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> YEW_WOOD = BLOCKS.register("yew_wood",
			() -> new YewWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> INFESTED_WOOD = BLOCKS.register("infested_wood",
			() -> new InfestedWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> CHARRED_WOOD = BLOCKS.register("charred_wood",
			() -> new CharredWoodBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> ICY_WOOD = BLOCKS.register("icy_wood",
			() -> new IcyWoodBlock(MaterialColor.LIGHT_BLUE, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> DISTORTED_WOOD = BLOCKS.register("distorted_wood",
			() -> new DistortedWoodBlock(MaterialColor.LIGHT_BLUE, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> TWISTED_WOOD = BLOCKS.register("twisted_wood",
			() -> new TwistedWoodBlock(MaterialColor.LIGHT_BLUE, Block.Properties.copy(Blocks.ACACIA_LOG)));
	public static final RegistryObject<Block> bloodoak_stripped_wood = BLOCKS.register("bloodoak_stripped_wood",
			() -> new LogBlock(MaterialColor.RED, Block.Properties.copy(Blocks.ACACIA_LOG)));
	...
	public static final RegistryObject<Block> ICY_STRIPPED_WOOD = BLOCKS.register("icy_stripped_wood",
			() -> new LogBlock(MaterialColor.LIGHT_BLUE, Block.Properties.copy(Blocks.ACACIA_LOG)));
	...
	public static final RegistryObject<Block> whiteoak_leaves = BLOCKS.register("whiteoak_leaves",
			() -> new LeavesBlock(Block.Properties.copy(Blocks.DARK_OAK_LEAVES)));
	public static final RegistryObject<Block> silverwood_leaves = BLOCKS.register("silverwood_leaves",
			() -> new LeavesBlock(Block.Properties.copy(Blocks.BIRCH_LEAVES)));
	...
	// Crates
	public static final RegistryObject<Block> bloodoak_crate = createCrate("bloodoak_crate");
	public static final RegistryObject<Block> whiteoak_crate = createCrate("whiteoak_crate");
	public static final RegistryObject<Block> SILVERWOOD_CRATE = createCrate("silverwood_crate");
	public static final RegistryObject<Block> WITCHWOOD_CRATE = createCrate("witchwood_crate");
	public static final RegistryObject<Block> ALDER_CRATE = createCrate("alder_crate");
	public static final RegistryObject<Block> HAWTHORN_CRATE = createCrate("hawthorn_crate");
	public static final RegistryObject<Block> ROWAN_CRATE = createCrate("rowan_crate");
	public static final RegistryObject<Block> WILLOW_CRATE = createCrate("willow_crate");
	public static final RegistryObject<Block> BEECH_CRATE = createCrate("beech_crate");
	public static final RegistryObject<Block> ASH_CRATE = createCrate("ash_crate");
	public static final RegistryObject<Block> BLACKTHORN_CRATE = createCrate("blackthorn_crate");
	public static final RegistryObject<Block> CEDAR_CRATE = createCrate("cedar_crate");
	public static final RegistryObject<Block> ELDER_CRATE = createCrate("elder_crate");
	public static final RegistryObject<Block> JUNIPER_CRATE = createCrate("juniper_crate"));
	public static final RegistryObject<Block> WITCHHAZEL_CRATE = createCrate("witchhazel_crate");
	public static final RegistryObject<Block> YEW_CRATE = createCrate("yew_crate");
	public static final RegistryObject<Block> INFESTED_CRATE = createCrate("infested_crate");
	public static final RegistryObject<Block> CHARRED_CRATE = createCrate("charred_crate");
	public static final RegistryObject<Block> ICY_CRATE = createCrate("icy_crate");
	public static final RegistryObject<Block> DISTORTED_CRATE = createCrate("distorted_crate");
	public static final RegistryObject<Block> TWISTED_CRATE = createCrate("twisted_crate");

	private static RegistryObject<Block> createCrate(String registryName){
		return BLOCKS.register(registryName, () -> new CrateBlock(Block.Properties.copy(Blocks.BARREL)));
	}

	// Doors
	public static final RegistryObject<Block> bloodoak_door = BLOCKS.register("bloodoak_door",
			() -> new ModDoor(Block.Properties.copy(Blocks.OAK_DOOR)));
	...
	public static final RegistryObject<Block> bloodoak_stairs = BLOCKS.register("bloodoak_stairs",
			() -> new StairsBlock(() -> BlockInit.BLOODOAK_PLANKS.get().getDefaultState(),
					Block.Properties.of(Material.WOOD, MaterialColor.RED)));
	public static final RegistryObject<Block> whiteoak_stairs = BLOCKS.register("whiteoak_stairs",
			() -> new StairsBlock(() -> BlockInit.WHITEOAK_PLANKS.get().getDefaultState(),
					Block.Properties.of(Material.WOOD, MaterialColor.WHITE_TERRACOTTA)));
	public static final RegistryObject<Block> silverwood_stairs = BLOCKS.register("silverwood_stairs",
			() -> new StairsBlock(() -> BlockInit.SILVERWOOD_PLANKS.get().getDefaultState(),
					Block.Properties.of(Material.WOOD, MaterialColor.BLUE)));
	...
	public static final RegistryObject<Block> alder_stairs = BLOCKS.register("alder_stairs",
			() -> new StairsBlock(() -> BlockInit.ALDER_PLANKS.get().getDefaultState(),
					Block.Properties.of(Material.WOOD, MaterialColor.ORANGE_TERRACOTTA)));
	...
	public static final RegistryObject<Block> rowan_stairs = BLOCKS.register("rowan_stairs",
			() -> new StairsBlock(() -> BlockInit.ROWAN_PLANKS.get().getDefaultState(),
					Block.Properties.of(Material.WOOD, MaterialColor.GREEN)));
	...
	public static final RegistryObject<Block> cedar_stairs = BLOCKS.register("cedar_stairs",
			() -> new StairsBlock(() -> BlockInit.CEDAR_PLANKS.get().getDefaultState(),
					Block.Properties.of(Material.WOOD, MaterialColor.BROWN_TERRACOTTA)));
	public static final RegistryObject<Block> elder_stairs = BLOCKS.register("elder_stairs",
			() -> new StairsBlock(() -> BlockInit.ELDER_PLANKS.get().getDefaultState(),
					Block.Properties.of(Material.WOOD, MaterialColor.BROWN)));
	...
	public static final RegistryObject<Block> charred_stairs = BLOCKS.register("charred_stairs",
			() -> new StairsBlock(() -> BlockInit.CHARRED_PLANKS.get().getDefaultState(),
					Block.Properties.of(Material.WOOD, MaterialColor.BLACK)));
	public static final RegistryObject<Block> ICY_STAIRS = BLOCKS.register("icy_stairs",
			() -> new StairsBlock(() -> BlockInit.ICY_PLANKS.get().getDefaultState(),
					Block.Properties.of(Material.WOOD, MaterialColor.LIGHT_BLUE)));
	...
	public static final RegistryObject<Block> pearlstone_stairs = BLOCKS.register("pearlstone_stairs",
			() -> new StairsBlock(() -> BlockInit.pearlstone.get().getDefaultState(),
					Block.Properties.of(Material.STONE, MaterialColor.WHITE_TERRACOTTA)));
	...
	public static final RegistryObject<Block> infestedstone_stairs = BLOCKS.register("infestedstone_stairs",
			() -> new StairsBlock(() -> BlockInit.infested_stone.get().getDefaultState(),
					Block.Properties.of(Material.STONE, MaterialColor.PURPLE)));
	...
	public static final RegistryObject<Block> bloodoak_button = BLOCKS.register("bloodoak_button",
			() -> new ModWoodButtonBlock(Block.Properties.of(Material.WOOD, MaterialColor.RED)));
	public static final RegistryObject<Block> whiteoak_button = BLOCKS.register("whiteoak_button",
			() -> new ModWoodButtonBlock(Block.Properties.of(Material.WOOD, MaterialColor.WHITE_TERRACOTTA)));
	public static final RegistryObject<Block> silverwood_button = BLOCKS.register("silverwood_button",
			() -> new ModWoodButtonBlock(Block.Properties.of(Material.WOOD, MaterialColor.BLUE)));
	...
	public static final RegistryObject<Block> alder_button = BLOCKS.register("alder_button",
			() -> new ModWoodButtonBlock(Block.Properties.of(Material.WOOD, MaterialColor.ORANGE_TERRACOTTA)));
	...
	public static final RegistryObject<Block> rowan_button = BLOCKS.register("rowan_button",
			() -> new ModWoodButtonBlock(Block.Properties.of(Material.WOOD, MaterialColor.GREEN)));
	...
	public static final RegistryObject<Block> beech_button = BLOCKS.register("beech_button",
			() -> new ModWoodButtonBlock(Block.Properties.of(Material.WOOD, MaterialColor.BROWN)));
	...
	public static final RegistryObject<Block> cedar_button = BLOCKS.register("cedar_button",
			() -> new ModWoodButtonBlock(Block.Properties.of(Material.WOOD, MaterialColor.BROWN_TERRACOTTA)));
	...
	public static final RegistryObject<Block> ICY_BUTTON = BLOCKS.register("icy_button",
			() -> new ModWoodButtonBlock(Block.Properties.of(Material.WOOD, MaterialColor.LIGHT_BLUE)));
	...
	public static final RegistryObject<Block> ICYSTONE_BUTTON = BLOCKS.register("icystone_button",
			() -> new ModStoneButtonBlock(Block.Properties.of(Material.STONE, MaterialColor.LIGHT_BLUE)));
	...
	public static final RegistryObject<Block> mysticstone_button = BLOCKS.register("mysticstone_button",
			() -> new ModStoneButtonBlock(Block.Properties.of(Material.STONE, MaterialColor.GRAY)));
	...
	public static final RegistryObject<Block> pearlstone_button = BLOCKS.register("pearlstone_button",
			() -> new ModStoneButtonBlock(Block.Properties.of(Material.STONE, MaterialColor.WHITE_TERRACOTTA)));
	...
	public static final RegistryObject<Block> charredstone_button = BLOCKS.register("charredstone_button",
			() -> new ModStoneButtonBlock(Block.Properties.of(Material.STONE, MaterialColor.BLACK)));
	...
	public static final RegistryObject<Block> infestedstone_button = BLOCKS.register("infestedstone_button",
			() -> new ModStoneButtonBlock(Block.Properties.of(Material.STONE, MaterialColor.PURPLE)));
	...
	public static final RegistryObject<Block> crimson_button = BLOCKS.register("crimson_button",
			() -> new ModStoneButtonBlock(Block.Properties.of(Material.STONE, MaterialColor.RED)));
	...
	public static final RegistryObject<Block> bloodoak_fence = BLOCKS.register("bloodoak_fence",
			() -> new FenceBlock(Block.Properties.of(Material.WOOD, MaterialColor.RED)));
	public static final RegistryObject<Block> whiteoak_fence = BLOCKS.register("whiteoak_fence",
			() -> new FenceBlock(Block.Properties.of(Material.WOOD, MaterialColor.WHITE_TERRACOTTA)));
	public static final RegistryObject<Block> silverwood_fence = BLOCKS.register("silverwood_fence",
			() -> new FenceBlock(Block.Properties.of(Material.WOOD, MaterialColor.BLUE)));
	...
	public static final RegistryObject<Block> alder_fence = BLOCKS.register("alder_fence",
			() -> new FenceBlock(Block.Properties.of(Material.WOOD, MaterialColor.ORANGE_TERRACOTTA)));
	...
	public static final RegistryObject<Block> beech_fence = BLOCKS.register("beech_fence",
			() -> new FenceBlock(Block.Properties.of(Material.WOOD, MaterialColor.BROWN)));
	...
	public static final RegistryObject<Block> cedar_fence = BLOCKS.register("cedar_fence",
			() -> new FenceBlock(Block.Properties.of(Material.WOOD, MaterialColor.BROWN_TERRACOTTA)));
	...
	public static final RegistryObject<Block> ICY_FENCE = BLOCKS.register("icy_fence",
			() -> new FenceBlock(Block.Properties.of(Material.WOOD, MaterialColor.LIGHT_BLUE)));
	...
	public static final RegistryObject<Block> WEEPING_VINES = BLOCKS.register("weeping_vines",
			() -> new WeepingVineBlock(Block.Properties.copy(Blocks.VINE)));
	public static final RegistryObject<Block> SPANISH_MOSS = BLOCKS.register("spanish_moss",
			() -> new SpanishMossBlock(Block.Properties.copy(Blocks.VINE)));
	...
	public static final RegistryObject<Block> LIVING_KELP = BLOCKS.register("living_kelp",
			() -> new ModKelpBlock(LIVING_KELP_TOP.get(),
					Block.Properties.copy(Blocks.KELP_PLANT).sound(SoundType.WET_GRASS).randomTicks()));

	// Special blocks
	public static final RegistryObject<Block> pandors_box = BLOCKS.register("pandors_box", () -> new PandorsBox(
			Block.Properties.copy(Blocks.BONE_BLOCK).notSolid().harvestTool(ToolType.PICKAXE).harvestLevel(1)));
	...
	public static final RegistryObject<Block> magic_quarry = BLOCKS.register("magic_quarry",
			() -> new BlockQuarry(Block.Properties.of(Material.METAL).sound(SoundType.LANTERN).notSolid()));
	...
	public static final RegistryObject<Block> HELL_FIRE = BLOCKS.register("hell_fire",
			() -> new HellFireBlock(Block.Properties.of(Material.FIRE).strength(0.5f, 15.0f)
					.sound(SoundType.field_226947_m_).noCollission().notSolid().lightValue(15)));
	...
	public static final RegistryObject<Block> ICY_BERRY_BUSH = NO_ITEM_BLOCK.register("icy_berry_bush",
			() -> new IcyBerryBushBlock(Block.Properties.of(Material.PLANT).noCollission().randomTicks()
					.sound(SoundType.SWEET_BERRY_BUSH)));
	public static final RegistryObject<Block> BLOOD_BERRY_BUSH = NO_ITEM_BLOCK.register("blood_berry_bush",
			() -> new BloodBerryBushBlock(Block.Properties.of(Material.PLANT).noCollission().randomTicks()
					.sound(SoundType.SWEET_BERRY_BUSH)));
	public static final RegistryObject<Block> SILVER_BERRY_BUSH = NO_ITEM_BLOCK.register("silver_berry_bush",
			() -> new SilverBerryBushBlock(Block.Properties.of(Material.PLANT).noCollission()
	...
	public static final RegistryObject<Block> CHARRED_BERRY_BUSH = NO_ITEM_BLOCK.register("charred_berry_bush",
			() -> new CharredBerryBushBlock(Block.Properties.of(Material.PLANT).noCollission()
					.randomTicks().sound(SoundType.SWEET_BERRY_BUSH)));
	public static final RegistryObject<Block> SOUL_BERRY_BUSH = NO_ITEM_BLOCK.register("soul_berry_bush",
			() -> new SoulBerryBushBlock(Block.Properties.of(Material.PLANT).noCollission().randomTicks()
					.sound(SoundType.SWEET_BERRY_BUSH)));
	public static final RegistryObject<Block> INFESTED_BERRY_BUSH = NO_ITEM_BLOCK.register("infested_berry_bush",
			() -> new InfestedBerryBushBlock(Block.Properties.of(Material.PLANT).noCollission()
					.randomTicks().sound(SoundType.SWEET_BERRY_BUSH)));
	public static final RegistryObject<Block> MYSTIC_BERRY_BUSH = NO_ITEM_BLOCK.register("mystic_berry_bush",
			() -> new MysticBerryBushBlock(Block.Properties.of(Material.PLANT).noCollission()
					.randomTicks().sound(SoundType.SWEET_BERRY_BUSH)));
