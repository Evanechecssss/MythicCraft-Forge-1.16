...
import com.masterquentus.mythiccraft.objects.items.VampiricStaffItem;
...
public class ItemInit {
	...
	public static final RegistryObject<ModSpawnEggItem> ILAGER_PILLAGER = ITEMS.register("ilager_pillager_spawn_egg",
			() -> new ModSpawnEggItem(ModEntityTypes.PILLAGER, 0x770000, 0x770000,
					new Item.Properties().tab(MythicCraftItems.instance).stacksTo(16)));
	public static final RegistryObject<ModSpawnEggItem> ILAGER_VINDICATOR = ITEMS
			.register("ilager_vindicator_spawn_egg", () -> new ModSpawnEggItem(ModEntityTypes.VINDICATOR, 0x770000,
					0x770000, new Item.Properties().tab(MythicCraftItems.instance).stacksTo(16)));
