...
public class AlderCrateTileEntity  extends LockableLootTileEntity {
	...
	public AlderCrateTileEntity(TileEntityType<?> typeIn) {
		super(typeIn);
	}
	
	public AlderCrateTileEntity() {
		this(ModTileEntityTypes.alder_crate.get());
	}
	...
	protected Container createMenu(int id, PlayerInventory player) {
		return new AlderCrateContainer(id, player, this);
	}
	...
	public static int getPlayersUsing(IBlockReader reader, BlockPos pos) {
		...
		if (blockstate.hasTileEntity()) {
			...
			if (tileentity instanceof AlderCrateTileEntity) {
				return ((AlderCrateTileEntity) tileentity).numPlayersUsing;
			}
		}
		return 0;
	}

	public static void swapContents(AlderCrateTileEntity te, AlderCrateTileEntity otherTe) {
