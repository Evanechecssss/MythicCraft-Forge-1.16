...
public class EntityRegistor {
	...
	public static void registor(FMLClientSetupEvent event) {
		...
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.WHITEOAK_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.SILVERWOOD_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.WITCHWOOD_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.ALDER_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.HAWTHORN_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.ROWAN_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.WILLOW_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.BEECH_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.ASH_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.BLACKTHORN_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.CEDAR_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.ELDER_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.JUNIPER_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.WITCHHAZEL_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.YEW_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.INFESTED_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.CHARRED_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.TWISTED_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.DISTORTED_BOAT.get(), ModBoatRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(ModEntityTypes.HELLBARK_BOAT.get(), ModBoatRenderer::new);
