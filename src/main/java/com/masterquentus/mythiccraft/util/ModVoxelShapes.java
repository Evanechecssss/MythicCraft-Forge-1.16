...
public class ModVoxelShapes {
	...
	public static final VoxelShape QUARRY = Stream.of(Block.box(7, 1.99584, 5.31703, 9, 7.99584, 7.31703),
			Block.box(0, 17, 0, 16, 28, 16), Block.box(7, 2.45672, 7, 9, 15.54328, 9),
			Block.box(4.7039, 8, 7, 11.2961, 10, 9), Block.box(7, 8, 4.7039, 9, 10, 11.2961),
			...
			Block.box(7, 10.00416, 5.31703, 9, 16.00416, 7.31703), Block.box(8.68297, 1.99584, 7, 10.68297, 7.99584, 9),
			Block.box(7, 1.99584, 8.68297, 9, 7.99584, 10.68297), Block.box(5.31703, 1.99584, 7, 7.31703, 7.99584, 9))
	...
	public static VoxelShape MAGIC_MIRROR = Stream.of(Block.box(8.5, -14, 0, 10.5, 20, 2),
			...
			Block.box(8.75, 19.5, 4.75, 10.25, 20.5, 11.25), Block.box(8.75, -9.5, 4.75, 10.25, -8.5, 11.25),
			Block.box(7.5, 16, 14.5, 8.5, 23, 15.5), Block.box(8.5, -14, 14, 10.5, 20, 16),
			Block.box(5, -16, 0, 14, -14, 2), Block.box(5, -16, 14, 14, -14, 16), Block.box(7, 20, 0, 12, 22, 2),
			Block.box(7, 20, 14, 12, 22, 16), Block.box(8.5, 22, 0, 10.5, 24, 2), Block.box(8.5, 22, 14, 10.5, 24, 16),
			Block.box(9, 4, -0.5, 10, 5, 0.5), Block.box(9, 4, 15.5, 10, 5, 16.5),
			Block.box(8.5, 18.5, 6.75, 10.5, 22, 7.5), Block.box(8.5, 18.5, 8.5, 10.5, 22, 9.25),
			Block.box(9, 18.75, 6.25, 10, 21.75, 9.75), Block.box(9, 17.75, 0.75, 10, 18.75, 5.75),
			Block.box(9, 17.75, 10.25, 10, 18.75, 15.25), Block.box(9, -7.75, 0.75, 10, -6.75, 5.75),
			Block.box(9, -7.75, 10.25, 10, -6.75, 15.25), Block.box(10.5, -15, 0.5, 11.5, 0, 1.5),
			Block.box(10.5, -15, 14.5, 11.5, 0, 15.5), Block.box(10.5, 16, 0.5, 11.5, 23, 1.5),
			Block.box(10.5, 16, 14.5, 11.5, 23, 15.5), Block.box(9, -16, -1, 10, -6, 0),
			Block.box(9, -16, 16, 10, -6, 17), Block.box(11.5, -15, 0.5, 12.5, -9, 1.5),
			Block.box(11.5, -15, 14.5, 12.5, -9, 15.5), Block.box(6.5, -15, 0.5, 7.5, -9, 1.5),
			Block.box(6.5, -15, 14.5, 7.5, -9, 15.5), Block.box(7.5, -15, 0.5, 8.5, 0, 1.5),
			Block.box(7.5, -15, 14.5, 8.5, 0, 15.5), Block.box(7.5, 16, 0.5, 8.5, 23, 1.5)).reduce((v1, v2) -> {
				return VoxelShapes.join(v1, v2, IBooleanFunction.OR);
			}).get();
}
