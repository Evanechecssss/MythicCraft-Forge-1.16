...
public class ModVoxelShapes {
	...
	public static VoxelShape MAGIC_MIRROR = Stream.of(Block.box(3.5, -7, 7.75, 15.5, 18, 8.25),
			Block.box(4.5, 18, 7.75, 14.5, 19, 8.25), Block.box(4.5, -8, 7.75, 14.5, -7, 8.25),
			Block.box(6.5, 19, 7.75, 12.5, 20, 8.25), Block.box(6.5, -9, 7.75, 12.5, -8, 8.25),
			Block.box(6.25, 19.5, 7.25, 12.75, 20.5, 8.75), Block.box(6.25, -9.5, 7.25, 12.75, -8.5, 8.75),
			Block.box(7.25, 20.5, 7.25, 11.75, 21, 8.75), Block.box(1.5, -14, 7, 3.5, 20, 9),
			Block.box(15.5, -14, 7, 17.5, 20, 9), Block.box(1.5, -16, 3.5, 3.5, -14, 12.5),
			Block.box(15.5, -16, 3.5, 17.5, -14, 12.5), Block.box(1.5, 20, 5.5, 3.5, 22, 10.5),
			Block.box(15.5, 20, 5.5, 17.5, 22, 10.5), Block.box(1.5, 22, 7, 3.5, 24, 9),
			Block.box(15.5, 22, 7, 17.5, 24, 9), Block.box(1, 4, 7.5, 2, 5, 8.5), Block.box(17, 4, 7.5, 18, 5, 8.5),
			Block.box(8.25, 18.5, 7, 9, 22, 9), Block.box(10, 18.5, 7, 10.75, 22, 9),
			Block.box(7.75, 18.75, 7.5, 11.25, 21.75, 8.5),
			Block.box(8.466599081811964, 18.90038996814247, 7.5, 13.466599081811964, 19.90038996814247, 8.5),
			Block.box(5.533400918188036, 18.90038996814247, 7.5, 10.533400918188036, 19.90038996814247, 8.5),
			Block.box(8.044666066640199, -8.984317663065923, 7.5, 13.044666066640199, -7.984317663065923, 8.5),
			Block.box(5.955333933359801, -8.984317663065923, 7.5, 10.955333933359801, -7.984317663065923, 8.5),
			Block.box(2, -15, 6, 3, 0, 7), Block.box(16, -15, 6, 17, 0, 7), Block.box(2, 16, 6, 3, 23, 7),
			Block.box(16, 16, 6, 17, 23, 7), Block.box(0.5, -16, 7.5, 1.5, -6, 8.5),
			Block.box(17.5, -16, 7.5, 18.5, -6, 8.5), Block.box(2, -15, 5, 3, -9, 6), Block.box(16, -15, 5, 17, -9, 6),
			Block.box(2, -15, 10, 3, -9, 11), Block.box(16, -15, 10, 17, -9, 11), Block.box(2, -15, 9, 3, 0, 10),
			Block.box(16, -15, 9, 17, 0, 10), Block.box(2, 16, 9, 3, 23, 10), Block.box(16, 16, 9, 17, 23, 10))
			.reduce((v1, v2) -> {
				return VoxelShapes.join(v1, v2, IBooleanFunction.OR);
			}).get();
}
