...
@OnlyIn(Dist.CLIENT)
public class WitchWoodCrateScreen extends ContainerScreen<WitchWoodCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public WitchWoodCrateScreen(WitchWoodCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
