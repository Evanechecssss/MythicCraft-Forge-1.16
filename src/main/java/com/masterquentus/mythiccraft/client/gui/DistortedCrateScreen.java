...
@OnlyIn(Dist.CLIENT)
public class DistortedCrateScreen extends ContainerScreen<DistortedCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public DistortedCrateScreen(DistortedCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
