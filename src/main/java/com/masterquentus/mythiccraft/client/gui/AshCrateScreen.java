...
@OnlyIn(Dist.CLIENT)
public class AshCrateScreen extends ContainerScreen<AshCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public AshCrateScreen(AshCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
