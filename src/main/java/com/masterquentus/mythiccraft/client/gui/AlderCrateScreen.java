...
@OnlyIn(Dist.CLIENT)
public class AlderCrateScreen extends ContainerScreen<AlderCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public AlderCrateScreen(AlderCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
