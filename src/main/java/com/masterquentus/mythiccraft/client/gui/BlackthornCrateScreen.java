...
@OnlyIn(Dist.CLIENT)
public class BlackthornCrateScreen extends ContainerScreen<BlackthornCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public BlackthornCrateScreen(BlackthornCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
