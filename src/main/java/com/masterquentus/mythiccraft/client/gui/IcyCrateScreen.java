...
@OnlyIn(Dist.CLIENT)
public class IcyCrateScreen extends ContainerScreen<IcyCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public IcyCrateScreen(IcyCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
