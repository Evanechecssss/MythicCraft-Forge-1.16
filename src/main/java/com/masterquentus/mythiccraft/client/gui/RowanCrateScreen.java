...
@OnlyIn(Dist.CLIENT)
public class RowanCrateScreen extends ContainerScreen<RowanCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public RowanCrateScreen(RowanCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
