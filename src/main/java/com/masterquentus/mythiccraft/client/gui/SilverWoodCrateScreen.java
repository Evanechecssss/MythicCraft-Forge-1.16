...
@OnlyIn(Dist.CLIENT)
public class SilverWoodCrateScreen extends ContainerScreen<SilverWoodCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public SilverWoodCrateScreen(SilverWoodCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
