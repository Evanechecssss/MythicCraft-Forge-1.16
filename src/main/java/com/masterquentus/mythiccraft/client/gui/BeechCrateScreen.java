...
@OnlyIn(Dist.CLIENT)
public class BeechCrateScreen extends ContainerScreen<BeechCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public BeechCrateScreen(BeechCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
