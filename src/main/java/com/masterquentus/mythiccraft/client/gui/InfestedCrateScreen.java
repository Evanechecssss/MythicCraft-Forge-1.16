...
@OnlyIn(Dist.CLIENT)
public class InfestedCrateScreen extends ContainerScreen<InfestedCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public InfestedCrateScreen(InfestedCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
