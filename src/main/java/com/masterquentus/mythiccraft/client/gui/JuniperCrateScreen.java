...
@OnlyIn(Dist.CLIENT)
public class JuniperCrateScreen extends ContainerScreen<JuniperCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public JuniperCrateScreen(JuniperCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
