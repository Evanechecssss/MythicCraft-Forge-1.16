...
@OnlyIn(Dist.CLIENT)
public class HawthornCrateScreen extends ContainerScreen<HawthornCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public HawthornCrateScreen(HawthornCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
