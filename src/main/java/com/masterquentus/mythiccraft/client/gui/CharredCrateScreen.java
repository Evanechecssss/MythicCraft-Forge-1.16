...
@OnlyIn(Dist.CLIENT)
public class CharredCrateScreen extends ContainerScreen<CharredCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public CharredCrateScreen(CharredCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
