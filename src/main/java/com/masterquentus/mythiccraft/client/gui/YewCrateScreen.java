...
@OnlyIn(Dist.CLIENT)
public class YewCrateScreen extends ContainerScreen<YewCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public YewCrateScreen(YewCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
