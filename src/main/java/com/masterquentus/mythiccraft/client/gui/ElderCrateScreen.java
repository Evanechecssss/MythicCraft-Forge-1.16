...
@OnlyIn(Dist.CLIENT)
public class ElderCrateScreen extends ContainerScreen<ElderCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public ElderCrateScreen(ElderCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
