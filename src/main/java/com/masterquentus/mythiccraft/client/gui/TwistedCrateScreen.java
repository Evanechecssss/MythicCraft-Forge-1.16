...
@OnlyIn(Dist.CLIENT)
public class TwistedCrateScreen extends ContainerScreen<TwistedCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public TwistedCrateScreen(TwistedCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
