...
@OnlyIn(Dist.CLIENT)
public class WillowCrateScreen extends ContainerScreen<WillowCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public WillowCrateScreen(WillowCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
