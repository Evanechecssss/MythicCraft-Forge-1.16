...
@OnlyIn(Dist.CLIENT)
public class CedarCrateScreen extends ContainerScreen<CedarCrateContainer> {
	
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(MythicCraft.MOD_ID, "textures/gui/crate.png");
	
	public CedarCrateScreen(CedarCrateContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
