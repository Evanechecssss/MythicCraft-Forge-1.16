...
public class YewBoatRenderer extends BoatRenderer {
    private static final ResourceLocation BOAT_TEXTURE =
            new ResourceLocation(MythicCraft.MOD_ID, "textures/entity/boats/yew.png");

    public YewBoatRenderer(EntityRendererManager p_i46179_1_) {
        super(p_i46179_1_);
    }
