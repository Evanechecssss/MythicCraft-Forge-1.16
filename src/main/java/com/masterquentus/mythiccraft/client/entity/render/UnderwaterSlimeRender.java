 ...
 * \
 */
public class UnderwaterSlimeRender extends GeoEntityRenderer<UnderwaterSlime> {
    public UnderwaterSlimeRender(EntityRendererManager renderManager) {
        super(renderManager, new UnderwaterSlimeModel());
    }

    @Override
    public RenderType getRenderType(UnderwaterSlime animatable, float partialTicks, MatrixStack stack, @Nullable IRenderTypeBuffer renderTypeBuffer, @Nullable IVertexBuilder vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
