...
public class ModWallTorchBlock extends WallTorchBlock {
		...
		public ModWallTorchBlock(Properties properties) {
			super(properties);
		}

	public static final DirectionProperty HORIZONTAL_FACING = HorizontalBlock.HORIZONTAL_FACING;
	public static final Map<Direction, VoxelShape> SHAPES = Maps
	...
	public void animateTick(BlockState stateIn, World worldIn, BlockPos pos, Random rand) {
		...
		worldIn.addParticle(ParticleTypes.FLAME, d0 + 0.27D * (double) direction1.getXOffset(), d1 + 0.22D,
				d2 + 0.27D * (double) direction1.getZOffset(), 0.0D, 0.0D, 0.0D);
	}
